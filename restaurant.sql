...
CREATE TABLE `EventsLocations` (
  `EventsLocationsID` int(6) NOT NULL AUTO_INCREMENT,
  `EventName` varchar(200) DEFAULT NULL,
  `Location` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`EventsLocationsID`)
