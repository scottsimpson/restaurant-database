...
CREATE SEQUENCE customers_customerid_seq start 101 increment 1;
...
CREATE SEQUENCE dishes_dishid_seq start 23 increment 1;

CREATE TABLE "Dishes" (
  DishID int PRIMARY KEY DEFAULT nextval('dishes_dishid_seq'),
  "Name" varchar(200) DEFAULT NULL,
  Description varchar(500) DEFAULT NULL,
  Price decimal(3,2) DEFAULT NULL
);

INSERT INTO "Dishes" VALUES (1,'Parmesan Deviled Eggs','These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.',8.00),
...
CREATE TABLE "CustomersDishes" (
  CustomersDishesID SERIAL PRIMARY KEY,
  CustomerID int DEFAULT NULL,
  DishID int DEFAULT NULL
);

INSERT INTO "CustomersDishes" (CustomerID, DishID) VALUES (7,3),(7,4),(7,21),(41,3),(41,8),(41,2),(35,8),(35,9);


CREATE SEQUENCE orders_orderid_seq start 11 increment 1;
...
INSERT INTO "Orders" VALUES (1,17,'2019-02-01 17:32:00'),
...
CREATE TABLE "OrdersDishes" (
  OrdersDishesID SERIAL PRIMARY KEY,
  OrderID int DEFAULT NULL,
  DishID int DEFAULT NULL
);

INSERT INTO "OrdersDishes" (OrderID, DishID) VALUES (1,12),(2,5),(2,9),(3,7),(3,10),(3,16),(4,14),(5,9),(5,19),(6,20),(6,8),(7,11),(7,11),(7,3),(8,16),(9,18),(9,22),(10,21),(10,13),(10,13);


CREATE SEQUENCE events_eventid_seq start 16 increment 1;

CREATE TABLE "Events" (
  EventID int PRIMARY KEY DEFAULT nextval('events_eventid_seq'),
  "Name" varchar(200) DEFAULT NULL,
  Description varchar(500) DEFAULT NULL,
...
INSERT INTO "Events" VALUES (1,'Winter Wonderland','Join us to celebrate 2014 in a garden of organic splendor! This event will focus on seasonal treats made with health in mind!','2014-01-01 18:00:00','Landon Hotel'),
...
(7,'Swing into Spring','Swing into Spring with your favorite springtime dishes! Fresh produce and delectable desserts will be featured during this vegan-friendly soiree!','2019-04-01 12:00:00','The Kale Grotto'),
...
CREATE TABLE "CustomersEvents" (
  CustomersEventsID SERIAL PRIMARY KEY,
  CustomerID int DEFAULT NULL,
  EventID int DEFAULT NULL
);

INSERT INTO "CustomersEvents" (CustomerID, EventID) VALUES (7,1),(7,2),(42,1),(89,1),(95,1),(4,1),(95,2),(42,5),(42,4),(71,1);


CREATE TABLE "EventsLocations" (
  EventsLocationsID SERIAL PRIMARY KEY,
  EventName varchar(200) DEFAULT NULL,
  Location varchar(200) DEFAULT NULL
);

INSERT INTO "EventsLocations" (EventName, Location) VALUES ('Winter Wonderland','Landon Hotel'),
...
INSERT INTO "Reservations" (CustomerID, "Date", PartySize) VALUES (17,'2019-02-05 14:00:00',3),
